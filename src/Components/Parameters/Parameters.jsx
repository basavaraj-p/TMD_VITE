            ...
            <CardContent>
              ...
              <Box mt={2}>
                ...
                <TextField
                  ...
                  value={config && config[0].heightCylinder}
                />
                <TextField
                  label="Top Cone Height(m)"
                  fullWidth
                  margin="normal"
                  color="success"
                  focused
                  ...
                  value={config && config[0].topHeightCone}
                />
                <TextField
                  ...
                  value={config && config[0].heightCone}
                />
                <TextField
                  label="Frustrum Radius(m)"
                  fullWidth
                  margin="normal"
                  color="success"
                  focused
                  ...
                  value={config && config[0].frustrumRadius}
                />
                <TextField
                  label="Caliberate"
                  fullWidth
                  ...
                  value={config && config[0].caliberate}
                />
                <TextField
                  label="TMD Radius(m)"
                  multiline
                  ...
                  value={config && config[0].tmdRadius}
                />
                <TextField
                  label="Cables"
                  fullWidth
                  ...
                  value={config && config[0].cables}
                />
                <TextField
                  label="Tilted X Angle(°)"
                  fullWidth
                  margin="normal"
                  color="success"
                  focused
                  ...
                  value={config && config[0].tiltedXAngle}
                />
                <TextField
                  label="Tilted Y Angle(°)"
                  fullWidth
                  margin="normal"
                  color="success"
                  focused
                  ...
                  value={config && config[0].tiltedYAngle}
                />
                <TextField
                  label="Tilted Z Angle(°)"
                  fullWidth
                  margin="normal"
                  color="success"
                  focused
                  ...
                  value={config && config[0].tiltedZAngle}
                />
                <TextField
                  label="Cable Density(g/cm³)"
                  fullWidth
                  margin="normal"
                  color="success"
                  focused
                  ...
                  value={config && config[0].cableDensity}
                />
                <TextField
                  label="Z Linespace"
                  fullWidth
                  ...
                  value={config && config[0].zLinspace}
                />
                <TextField
                  label="Steps To Be Decremented"
                  fullWidth
                  margin="normal"
                  color="success"
                  focused
                  ...
                  value={config && config[0].stepsToBeDecremented}
                />
              </Box>
            </CardContent>
          </Card>
